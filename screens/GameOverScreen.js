    ...
    return(
        <View style={styles.screen}>
            ...
            <View style={{marginHorizontal: 50}}>
                <TextRegular style={{textAlign: "center"}}>Your phone needed <Text style={styles.highlight}>{props.roundsNumber}</Text> rounds to guess the number <Text style={styles.highlight}>{props.userNumber}</Text></TextRegular>
            </View>
            <View style={{maxWidth: "50%", width: 200, marginTop: 20}}>
                <Button color={Colors.accent} title="NEW GAME" onPress={props.onRestart} />
            </View>
        </View>
    );
};
